...
class ModuleGenerator extends Generator
{
    ...
    public function generateResources()
    {
        ...
        $this->console->call('module:make-observer', [
            'observer' => $this->getName() . 'Observer',
            'module' => $this->getName(),
        ]);

        $this->console->call('module:make-request', [
            'name' => $this->getName().'/CreateRequest',
            'module' => $this->getName(),
        ]);
        $this->console->call('module:make-request', [
        ...
        $this->console->call('module:make-request', [
            'name' => $this->getName().'/DeleteRequest',
            'module' => $this->getName(),
        ]);
